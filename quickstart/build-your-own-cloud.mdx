...
You’ll now need to lease instance(s) for the data plane. The easiest way to do this is to lease an instance from a bare metal provider. Hetzner has server auctions available, where you pay monthly for bare metal: <Link url="https://www.hetzner.com/sb"/>
...
If your ISP doesn't support IPv6, please use a VPN or tunnel broker such Mullvad or Hurricane Electric's <Link url="https://tunnelbroker.net"/>. Alternatively, you could lease IPv4 addresses from your provider and add them to your control plane.
