...
You can use Ubicloud without installing anything: <Link url="https://console.ubicloud.com/create-account"/>. The first time you use Ubicloud, you’ll need to create a new account. Once you do that and sign in, you’ll be directed to Ubicloud’s home page.
