...
- [GitHub Actions](#github-actions): \$0.0016/min on Ubicloud vs. \$0.008/min on GitHub
- [Compute (VMs)](#compute): \$33.52/month on Ubicloud vs. \$90/month on AWS Germany
- [Managed PostgreSQL](#managed-postgresql): \$62.52/month on Ubicloud vs. \$200/month on AWS Germany
- [Burstable VMs](#burstable-vms) start at \$8.38/month and [Hobby Managed PostgreSQL](#hobby-postgresql) starts at \$15.63/month


## GitHub Actions

Ubicloud runners come with dedicated CPU, memory, local block storage, and a public IPv4 address. Our GitHub Managed Runner Application allocates virtual machines (VMs) across data centers in Germany to provide high availability. Every account gets a \$2/month credit that's equivalent to 1,250 minutes of Ubicloud runner time.
...
|------|--------|------------------|------------------|
| 2    | 8GB    | \$0.0010/min     | \$0.0016/min     |
| 4    | 16GB   | \$0.0020/min     | \$0.0032/min     |
| 8    | 32GB   | \$0.0040/min     | \$0.0064/min     |
| 16   | 64GB   | \$0.0080/min     | \$0.0128/min     |
| 30   | 120GB  | \$0.0150/min     | \$0.0240/min     |

<Info>
  **Standard runners** were deprecated in June 2026 and are only available to customers who were using them prior to that date. All new users get the superior performance of our premium runners by default.
</Info>
...
|:---------------:|:----:|:------:|:-------:|:---------------------------------:|
|    standard-2   |   2  |   8GB  |   40GB  | \$0.00083/min <br/> (\$33.52/mo)  |
|    standard-4   |   4  |  16GB  |   80GB  | \$0.00166/min <br/> (\$67.03/mo)  |
|    standard-8   |   8  |  32GB  |  160GB  | \$0.00332/min <br/> (\$134.06/mo) |
|   standard-16   |  16  |  64GB  |  320GB  | \$0.00665/min <br/> (\$268.13/mo) |
|   standard-30   |  30  |  120GB |  600GB  | \$0.01247/min <br/> (\$502.74/mo) |
|   standard-60   |  60  |  240GB |  1200GB | \$0.02494/min <br/> (\$1005.48/mo) |
...
| Virtual Machine | vCPU | Memory | Storage |               Pricing             |
|:---------------:|:----:|:------:|:-------:|:---------------------------------:|
|   burstable-1   |   1  |   2GB  |   10GB  | \$0.00021/min <br/> (\$8.38/mo)   |
|   burstable-2   |   2  |   4GB  |   20GB  | \$0.00042/min <br/> (\$16.76/mo)  |
...
|:-----------:|:----:|:------:|:-------:|:-------------:|
|  standard-2 |   2  |   8GB  |   64GB  |       $62     |
|  standard-4 |   4  |  16GB  |  128GB  |      $125     |
|  standard-8 |   8  |  32GB  |  256GB  |      $250     |
| standard-16 |  16  |  64GB  |  512GB  |      $500     |
| standard-30 |  30  |  120GB | 1,024GB |      $944     |
| standard-60 |  60  |  240GB | 2,048GB |     $1785     |
...
|  PostgreSQL  | vCPU | Memory | Storage | Monthly Price |
|:------------:|:----:|:------:|:-------:|:-------------:|
|  hobby-1     |   1  |   2GB  |   16GB  |      $15.63   |
|  hobby-2     |   2  |   4GB  |   32GB  |      $31.27   |
...
|:---------------------------:|:------------:|:------------------------------------------:|:-------------:|
|  Single node <br/> (non-HA) |           1  | 2 vCores, 8 GB memory, 40GB local storage  |        $57.46 |
|  Single node <br/> (non-HA) |           3  | 2 vCores, 8 GB memory, 40GB local storage  |       $132.05 |
|  Single node <br/> (non-HA) |          10  | 2 vCores, 8 GB memory, 40GB local storage  |       $393.12 |
|                3 nodes (HA) |           3  | 2 vCores, 8 GB memory, 40GB local storage  |       $172.37 |
|                3 nodes (HA) |           5  | 2 vCores, 8 GB memory, 40GB local storage  |       $246.96 |
|                3 nodes (HA) |          10  | 2 vCores, 8 GB memory, 40GB local storage  |       $433.33 |
