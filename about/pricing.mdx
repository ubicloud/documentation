...
| vCPU | RAM  | GPU                         | Pricing    |
|------|------|-----------------------------|------------|
| 6    | 32GB | 1x RTX 4000 Ada 20GB Memory | \$0.032/min |
...
However, if you notice runners consistently waiting due to concurrency limits and it impacts your workflows, you’re welcome to contact us. We're happy to review your usage and, if needed, offer options to increase your baseline concurrency for an additional fee. Reach out to us at [support@ubicloud.com](mailto:support@ubicloud.com) discuss your needs.
