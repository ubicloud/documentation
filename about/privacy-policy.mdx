...
To exercise these rights, please send an email to <Link title="info@ubicloud.com" url="mailto:info@ubicloud.com"/>. To verify your identity for security, we may request extra information before addressing your data-related request. You may also have the right to complain to your local Data Protection Authority. Customers within EEA can find authority contacts on the European Data Protection Board website. We aim to promptly respond to requests in compliance with legal requirements.

## Contact us

Contact us by emailing <Link title="info@ubicloud.com" url="mailto:info@ubicloud.com"/>. Ubicloud B.V. Turfschip 267, Amstelveen, 1186 XK, The Netherlands.
