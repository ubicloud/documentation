...
description: 'Last updated: 09/01/2026'
---

## Customer Content Data

| Name of Sub-Processor | Nature of Processing Activity            | Location of Processing | Ubicloud Region |
|-----------------------|------------------------------------------|------------------------|-----------------|
| Hetzner               | Infrastructure (server) and data hosting | Germany and Finland    | EU              |
| Leaseweb Germany      | Infrastructure (server) and data hosting | Germany                | EU              |
| Latitude.sh           | Infrastructure (server) and data hosting | Germany                | EU              |
| Leaseweb US           | Infrastructure (server) and data hosting | USA                    | US              |
...
Customer content data for all Ubicloud managed services are hosted within the region, where the resource was provisioned. For the GitHub Actions service, Ubicloud runners process data within Europe by default. In some cases, workloads may fall back to the USA if explicitly enabled at the customer's request. If you need to enable or disable specific regions for Ubicloud runners, please get in touch with our team at [support@ubicloud.com](mailto:support@ubicloud.com).
...
| Lemlist               | Sales engagement and outreach                                            | Global                 |
