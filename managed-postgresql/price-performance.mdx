---
title: 'PostgreSQL Price-Performance'
sidebarTitle: 'Price-Performance'
---

Ubicloud Managed PostgreSQL provides **7x** better price-performance compared to similar managed PostgreSQL services thanks to its unique architecture based on NVMe SSD storage. The following benchmarks compare Ubicloud PostgreSQL with AWS Aurora and AWS RDS PostgreSQL.

## TPC-C Benchmark
Ubicloud PostgreSQL runs **1.4x** more transactions than AWS Aurora and costs **3.7x** less. Similarly, Ubicloud Postgres runs **4.6x** more transactions than AWS RDS and costs **1.8x** less. Ubicloud PostgreSQL also has **1.91x** lower latency compared to AWS Aurora and **7.65x** lower latency than AWS RDS PostgreSQL.
...
|        **Price**        |   409.37 |  1501.00 |  725.02 |
|    **TPS Difference**   |     -    |    1.37x |   4.64x |
|      **Price-TPS**      |     -    |    5.03x |   8.21x |
|  **Latency Difference** |     -    |    1.91x |   7.65x |
|    **Price-Latency**    |     -    |    7.01x |  13.55x |

## TPC-H Benchmark
Ubicloud PostgreSQL runs 22 TPC-H queries **2.42x** faster than AWS Aurora and **2.96x** faster than AWS RDS PostgreSQL, while costing **4.06x** less than AWS Aurora and **1.90x** less than AWS RDS PostgreSQL.
...
|           **Price ($)**          |   344.86 |     1401.57 |      654.87 |
|    **Performance Difference**    |     -    |       2.42x |       2.96x |
|      **Price-Performance**       |     -    |       9.83x |       5.62x |
