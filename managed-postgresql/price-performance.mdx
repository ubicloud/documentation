...
## TPC-C Benchmark
Ubicloud PostgreSQL runs **1.37x** more transactions compared to AWS Aurora and **4.64x** more transactions than AWS RDS PostgreSQL, while costing **5.77x** less than AWS Aurora and **2.79x** less than AWS RDS PostgreSQL. Ubicloud PostgreSQL also has **1.91x** lower latency compared to AWS Aurora and **7.65x** lower latency than AWS RDS PostgreSQL.
...
## TPC-H Benchmark
Ubicloud PostgreSQL runs 22 TPC-H queries **3.77x** faster than AWS Aurora and **3.75x** faster than AWS RDS PostgreSQL, while costing **6.40x** less than AWS Aurora and **3.00x** less than AWS RDS PostgreSQL.  
