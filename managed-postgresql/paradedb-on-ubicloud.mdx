...
![ParadeDB on Ubicloud](/managed-postgresql/paradedb-on-ubicloud-1.png)
...
You can learn more about ParadeDB's capabilities and how to use them in <Link title="this quick start guide" url="https://docs.paradedb.com/documentation/getting-started/quickstart"/>.