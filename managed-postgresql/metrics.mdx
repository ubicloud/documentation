...
attributed to user, system, iowait and steal. The user time reflects processing
in the Postgres instance, while the system time reflects operating system (i.e.
kernel) operations.
