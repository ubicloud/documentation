---
title: 'Machine Images Quickstart'
sidebarTitle: 'Quickstart'
---

In this guide you'll capture a machine image from an existing VM, publish it as the latest version, and boot a new VM from it using the [Ubicloud console](https://console.ubicloud.com/login).
