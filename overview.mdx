...
- You're using GitHub Actions. Ubicloud supports managed x64 and arm64 runners; and reduces your bill by 7x. To get started, you just need to change 1 line in your workflow file.
