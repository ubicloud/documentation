...
### Performance Improvements Up to 13% On Larger Instances

Ubicloud PostgreSQL now ships with hugepages enabled by default, significantly boosting performance, especially on large instance types
