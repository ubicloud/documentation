...
Operating system used by all default Ubicloud runner types will be updated from Ubuntu 22.04 to Ubuntu 24.04 on November 23. All jobs using the label `ubicloud`, `ubicloud-standard-2`, `ubicloud-standard-4`, `ubicloud-standard-8`, `ubicloud-standard-16`, `ubicloud-standard-30`, `ubicloud-standard-60`, `ubicloud-arm`, `ubicloud-standard-2-arm`, `ubicloud-standard-4-arm`, `ubicloud-standard-8-arm`, `ubicloud-standard-16-arm`, `ubicloud-standard-30-arm` or `ubicloud-standard-60-arm` will start using Ubuntu 24.04. You can use Ubuntu 22.04 by explicitly specifying the operating system version in the runner label, for instance using `ubicloud-standard-2-ubuntu-2204` instead of `ubicloud-standard-2`.
