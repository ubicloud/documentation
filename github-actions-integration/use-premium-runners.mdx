...
Ubicloud Premium Runners are powered by AMD Ryzen 9 7950X3D CPUs, high-performance gaming processors optimized for single-thread speed and fast CI execution, priced at just 1/3th the cost of GitHub-hosted runners.
...
1. Go to the [Ubicloud Console](https://console.ubicloud.com/login)
