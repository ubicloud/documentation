---
title: 'GitHub Actions Price-Performance'
...
We charge only for usage and at per minute granularity. Every account gets a $2.5/month credit that's equivalent to 1,250 minutes of Ubicloud (2 vCPU) runner time. You can read more about our Linux x64 and arm64 prices in the [general pricing page](/about/pricing#github-actions).
