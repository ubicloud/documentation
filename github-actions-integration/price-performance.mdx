...
We charge only for usage and at per minute granularity. Every account gets a $1/month credit that's equivalent to 1,250 minutes of Ubicloud (2 vCPU) runner time. You can read more about our Linux x64 and Arm64 prices, as well as our GPU runners, in the <Link title="general pricing page" url="/about/pricing"/>.
