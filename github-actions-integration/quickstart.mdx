...
<Steps stepSize="h1">
  <Step title="Sign up and sign in">
    The first time you use Ubicloud, you'll need to <Link title="create a new account" url="https://console.ubicloud.com/create-account"/>. Once you do that and sign in, you'll be directed to Ubicloud's home page.
  </Step>
