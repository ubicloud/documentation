...
- Reduce your GitHub Actions bill by 7x
...
<Steps stepSize="h1">
  <Step title="Sign up and sign in">
    The first time you use Ubicloud, you'll need to [create a new account](https://console.ubicloud.com/?setup=github_actions&source=docs&source_detail=github-quickstart). Once you do that and sign in, you'll be directed to Ubicloud's home page.
  </Step>
  <Step title="Enter billing details">
    ...
    Ubicloud also provides a billing credit of $2.5/month for an account. This means you'll get 1,250 free minutes of GitHub runner credits each month.
  ...
  <Step title="Change your `workflow.yml` file">
    ...
    By default, `ubicloud-standard-2` starts a VM with the same vCPU and memory configuration as paid GitHub runners. Given Ubicloud's 7x price advantage, you might want to pick a more powerful VM such as `ubicloud-standard-8` and see if your pipelines move faster. You can find the full list of runners and their prices in the [Pricing documents](/about/pricing#github-actions).
  </Step>
</Steps>

<Tip>
    **Allowlisting Ubicloud IPs:** If your workflows need to access services behind a firewall (e.g., private APIs, databases, or registries), you may need to allowlist Ubicloud's IP ranges listed at https://api.ubicloud.com/ips-v4. You can find the more information about retrieving IPv4 ranges at the [Public IP Ranges](/networking/public-ip-ranges) page.
</Tip>
...
<Info>
    **Summary:** In this guide, you created a Ubicloud account and integrated that account with your GitHub Account. You then changed a single line in your workflow file to use Ubicloud runners.
    ...
    This resulted in 7x lower prices and faster CI/CD, with Ubicloud's source code openly available under the AGPL license.
</Info>
