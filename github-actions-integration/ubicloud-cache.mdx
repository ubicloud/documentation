...
You can disable cache branch protection in the Ubicloud console under your GitHub installation settings to share caches across all branches.

<Warning>
Disabling cache branch protection on public repositories should be done with caution. If not all contributors are trusted, sharing caches across branches may lead to cross-branch cache poisoning attacks.
</Warning>

## Ubicloud Cache Actions (Deprecated)
