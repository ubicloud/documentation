...
<Info>
  **Summary:** You created a VM in this quick start guide. The VM comes with
  local block storage and has its own virtual private network. The data gets
  encrypted at rest and in transit; and you can collaborate with others using
  Attribute-Based Access Control (ABAC). If you used the default provider, this
  VM will cost you 3x lower than it would with AWS in similar cloud regions.
</Info>
